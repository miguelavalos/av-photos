...
2. Do not commit `.env`, `.env.*`, `.infisical/bootstrap.env`, signing files, provisioning profiles, or generated build output.
3. Do not commit real Clerk keys, backend tokens, subscription sync tokens, or private service credentials.
